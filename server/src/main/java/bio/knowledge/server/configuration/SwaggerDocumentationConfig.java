...
public class SwaggerDocumentationConfig {
    ...
    ApiInfo apiInfo() {
        return new ApiInfoBuilder()
            ...
            .description("This is a reference implementation of the Translator Knowledge Beacon web service  application programming interface (API), which wraps the Semantic Medline Database. ")
            .license("MIT License")
