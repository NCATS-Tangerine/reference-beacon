...
public class EvidenceApiController implements EvidenceApi {
    ...
    public ResponseEntity<List<InlineResponse2005>> getEvidence(@ApiParam(value = "(url-encoded) CURIE identifier of the concept-relationship statement (\"assertion\", \"claim\") for which associated evidence is sought ",required=true ) @PathVariable("statementId") String statementId,
