...
public class ConceptsApiController implements ConceptsApi {
    ...
    public ResponseEntity<List<ConceptDetail>> getConceptDetails(@ApiParam(value = "(url-encoded) CURIE identifier of concept of interest",required=true ) @PathVariable("conceptId") String conceptId) {
        // do some magic!
        return new ResponseEntity<List<ConceptDetail>>(HttpStatus.OK);
    }
